...
In our code, we provide an exmaple to recovering the five critical points vector field. The dimension of this data set is 51 by 51 by 51.
...
## Data preparation
2k binary files are required for the model training (k is the number of traced streamlines). The first k files are the position information in the traced streamline. The second k files are the velocity information in the traced streamline.
