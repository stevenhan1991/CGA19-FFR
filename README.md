...
## Data preparation
2k binary files are required for the model training (k is the number of traced streamlines). The first k files are the position informaton in the traced each streamline. The second k files are the velocity information in the traced each streamline.
